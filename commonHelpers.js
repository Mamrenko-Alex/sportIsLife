var J=Object.defineProperty;var D=(t,e,s)=>e in t?J(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var B=(t,e,s)=>(D(t,typeof e!="symbol"?e+"":e,s),s);import"./assets/main-e96f0783.js";import{i as P,g as z,a as Q,b as G,c as K,d as Y,e as N,s as W,G as w,f as X,h as Z,j as g}from"./assets/vendor-ac1aa0cc.js";function V(){document.querySelector(".filter-list-js").classList.add("hidden-form");const e=document.querySelector(".wrap-js"),s=document.createElement("p");s.className="favorite-text",e.appendChild(s),s.textContent="It appears that you haven`t added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future."}const n="/sportIsLife/assets/sprite-9db62079.svg",h=(t,e)=>t.length<=e?t:`${t.slice(0,e)}...`;function tt(t){const e=document.querySelector(".filter-list-js");e.classList.remove("hidden-form"),t.length>6?e.classList.add("scroll"):e.classList.remove("scroll");const s=t.map(({_id:a,target:r,name:l,bodyPart:c,burnedCalories:i,time:L})=>`
